...
?>
<?php form_open("$index_page/CustomerController/getCustomerByName/"); ?>
				...
				foreach ($AllCustomers as $customer){
				 echo "<tr>";
					...
					echo "<td>" . $customer['contactFirstName'] . "</td>";
 			    	...
 			    	echo "<td> <a href=\"$index_page/CustomerController/getDrillDownCustomer/" . $customer['customerNumber'] ."\"> More...</a></td>" ;
				 echo "</tr>";
				}
				?>
                </table>
